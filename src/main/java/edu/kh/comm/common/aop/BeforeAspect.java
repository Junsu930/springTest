...
public class BeforeAspect {
	...
	// Joinpoint 인터페이스 : 
	// advice가 적용되는 Target Object (Service Impl)의 
	// 		정보, 전달되는 매개변수, 매서드, 반환값, 예외 등을 얻을 수 있는 메서드를 제공
	
	// (주의사항) JoinPoint 인터페이스는 항상 첫번째 매개변수로 작성되어야 한다.
	...
	public void serviceStart(JoinPoint jp) {
		...
		try {
			...
			// ip : xxx.xxx.xxx.xxx (email : test1@naver.com)
